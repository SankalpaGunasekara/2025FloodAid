                  ...
                  {requests.filter(r => r.status === 'completed').map(req => (
                    <div key={req.id} className="bg-white p-4 rounded-xl shadow-sm border border-green-100 flex flex-col gap-2">
                      <div className="flex justify-between items-start">
                        ...
                        <span className="bg-green-100 text-green-700 text-xs font-bold px-2 py-1 rounded-full flex items-center gap-1"><CheckCircle size={12} /> {t.completed}</span>
                      </div>
